...
export const OfferEditor = ({ application, onUpdate }: OfferEditorProps) => {
    ...
    const getOfferLetterPDF = async () => {
        ...
        const position = offerDetails.customPosition || application.position;
        ...
        try {
            ...
            const htmlMessage = `
                <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 680px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e2e8f0;">
                    <!-- Letterhead Header -->
                    <div style="background-color: #ffffff; padding: 20px 40px; border-bottom: 3px solid #0f172a;">
                        <table style="width: 100%;">
                            <tr>
                                <td align="left">
                                    <h1 style="margin: 0; color: #0f172a; font-size: 24px; font-weight: 700;">GOAI TECHNOLOGIES</h1>
                                    <p style="margin: 5px 0 0; color: #64748b; font-size: 12px; letter-spacing: 1px;">INNOVATION FOR RETAIL</p>
                                </td>
                                <td align="right">
                                    <!-- Use a public URL for the logo if possible, otherwise rely on alt text or attachment -->
                                    <img src="https://go-aitech.com/logo.png" alt="GoAI Logo" style="height: 50px;" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div style="padding: 40px; color: #334155; line-height: 1.8; font-size: 15px;">
                        ...
                        <p style="margin-bottom: 24px;">Dear <strong>${application.full_name}</strong>,</p>
                        
                        <p>We are delighted to extend this offer of internship to you for the position of <strong>${position}</strong> at GoAI Technologies Pvt Ltd.</p>

                        <p>We were impressed by your background and enthusiasm, and we believe you will be a valuable addition to our team.</p>
                        
                        <div style="background-color: #f8fafc; border-left: 4px solid #10b981; padding: 20px; margin: 30px 0;">
                    ...
                    <div style="background-color: #f1f5f9; padding: 20px 40px; text-align: center; border-top: 1px solid #e2e8f0; font-size: 12px; color: #94a3b8;">
                         <p style="margin: 0;"><strong>GoAI Technologies Pvt Ltd</strong></p>
            ...
            const finalHtmlMessage = htmlMessage.replace(
                'CHECK_BUTTON_PLACEHOLDER',
                `<a href="${onboardingLink}" style="display: inline-block; background-color: #0f172a; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 4px; font-weight: 600; font-size: 16px;">Complete Onboarding</a>`
            );
